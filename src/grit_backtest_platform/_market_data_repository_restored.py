...
def _rebuild_fundamental_points_available_at_pk(conn: sqlite3.Connection) -> None:
    ...
    conn.execute(
        ...
        INSERT OR REPLACE INTO dataset_fundamental_points (
            ...
            shares_outstanding, total_assets, total_liabilities, current_assets, current_liabilities, long_term_debt,
        ...
        SELECT
            ...
            ltm_earnings, revenue, gross_profit, net_income, market_cap, book_value_equity,
            operating_cash_flow, capex, enterprise_value, total_shares,
            COALESCE(shares_outstanding, total_shares), total_assets, total_liabilities, current_assets, current_liabilities, long_term_debt,
            total_debt, cash_and_equivalents,
            provider_market_cap, provider_enterprise_value,
            market_cap_source, enterprise_value_source,
            source, fallback_source, metadata_json
