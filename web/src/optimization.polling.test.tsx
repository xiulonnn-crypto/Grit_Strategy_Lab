...
describe('optimization polling', () => {
  it('avoids overlapping detail requests while a poll is still in flight', async () => {
    ...
    let resolveRefresh: ((value: ApiOptimizationJobDetail) => void) | null = null;
    ...
    expect((currentApi.getOptimizationJobDetail as ReturnType<typeof vi.fn>).mock.calls.length).toBe(1);
    ...
    expect((currentApi.getOptimizationJobDetail as ReturnType<typeof vi.fn>).mock.calls.length).toBe(2);
